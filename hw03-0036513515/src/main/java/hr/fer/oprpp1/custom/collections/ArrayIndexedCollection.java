...
public class ArrayIndexedCollection<E> implements List<E> {
	...
	public ArrayIndexedCollection(Collection<? extends E> other, int initialCapacity) {
		...
		this.modificationCount = 0;
		this.array = (E[]) new Object[((other.size() > initialCapacity) ? other.size() : initialCapacity)];
		this.addAll(other);
	}
	...
	/**
	 * Pomoćna metoda za realokaciju polja u slučaju prepunjenja.
	 */
	@SuppressWarnings("unchecked")
	private void resize() {
