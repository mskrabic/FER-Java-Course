...
public class NewtonParallel {
	...
	public static class NewtonParallelProducer implements IFractalProducer {
		...
		public void produce(double reMin, double reMax, double imMin, double imMax,
			...
			final BlockingQueue<NewtonTask> queue = new LinkedBlockingQueue<>();
	...
	public static class NewtonTask implements Runnable {
		...
		/**
		 * Prazni posao koji se koristi za thread-poisoning.
		 */
		public static final NewtonTask NO_JOB = new NewtonTask();
		
		/**
		 * Privatni konstruktor za inicijalizaciju praznog posla.
		 */
		private NewtonTask() {
		}
